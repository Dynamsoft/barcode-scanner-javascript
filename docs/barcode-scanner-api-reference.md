...
`templateName` (optional): The name of the [`CaptureVisionTemplate`](https://www.dynamsoft.com/capture-vision/docs/web/programming/javascript/api-reference/capture-vision-router/preset-templates.html) to be used.
...
Specifies the barcode formats to recognize. See [EnumBarcodeFormat](https://www.dynamsoft.com/barcode-reader/docs/web/programming/javascript/api-reference/enum-barcode-format.html).
...
**Type:** [`Array<BarcodeResultItem>`](https://www.dynamsoft.com/barcode-reader/docs/web/programming/javascript/api-reference/interfaces/barcode-result-item.html)
...
**Type:** [`DSImageData`](https://www.dynamsoft.com/capture-vision/docs/web/programming/javascript/api-reference/core/basic-structures/ds-image-data.html)
