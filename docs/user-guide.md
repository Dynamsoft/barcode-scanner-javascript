...
We recommend using this guide as a reference when creating your own application. If you are looking for a fully customizable barcode decoding library, you are welcome to use the [Foundational APIs](https://www.dynamsoft.com/barcode-reader/docs/web/programming/javascript/user-guide/).
...
A license key is required to use the SDK. Get a 30-day free trial license at:
<https://www.dynamsoft.com/customer/license/trialLicense?product=dbr&package=js>
...
- **`scanMode: SM_MULTI_UNIQUE`** — Keeps the scanner open and collects unique barcodes (deduplicated by format + text within a 3-second window). See [scanMode](./barcode-scanner-api-reference.md#scanmode) in the API Reference.
...
1. Learn how to [Customize the Barcode Scanner](./barcode-scanner-customization.md)
2. Check out the [RTU API Samples and Demo](https://dynamsoft.github.io/barcode-scanner-javascript/)
3. Learn about the [BarcodeScanner API](./barcode-scanner-api-reference.md)
...
```sh
npm i dynamsoft-barcode-reader-bundle@11.4.3000
# or
yarn add dynamsoft-barcode-reader-bundle@11.4.3000
```
...
[Download the SDK](https://www.dynamsoft.com/barcode-reader/downloads/?ver=11.4.3000&utm_source=guide&product=dbr&package=js), copy the `dist` folder to your server, and include it:
